...
class PurchaseRepository {
  constructor(pool) {
    this.places = new LocationRepository(pool); this.movements = new MovementRepository(pool);
  ...
  async insertLine(c,purchaseId,presentationId,locationId,line,baseQuantity) {
    ...
    await this.movements.insert(c,{lotId:lot.insertId,destinationId:locationId,userId:purchase.userId,type:'COMPRA',quantity:baseQuantity,before:'0.000',after:baseQuantity,reason:'COMPRA N.º '+purchaseId});
  }
}
