...
class PurchaseMemoryPool {
 constructor(){this.queue=Promise.resolve();this.data={suppliers:[],products:[],presentations:[],purchases:[],lines:[],operations:new Map()};}
...
class PurchaseMemoryRepository extends Repository {
 ...
 async location(c,id){return Number(id)===1?{state:'ACTIVO'}:null;}
 async locations(){return {options:[{value:'1',label:'ALMACÉN DE PRUEBA'}],total:1};}
